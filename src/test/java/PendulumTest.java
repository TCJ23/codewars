...
public class PendulumTest {
    ...
    @Test
    public void shouldFindMiddleIndex() {
        int[] array = new int[]{1, 2, 3, 4};
        Pendulum pendulum = new Pendulum();
        int middleIndex = pendulum.findMiddleIndex(array);
        System.out.println(middleIndex);
    }

    @Test
    public void assigntToMiddleIndex() {
        int[] array = new int[]{8,7,10,3};
        Pendulum pendulum = new Pendulum();
        int middleIndex = pendulum.findMiddleIndex(array);
        int[] ints = pendulum.assignToProperIndex(array, middleIndex);
        for (int anInt : ints) {
    ...
    public void shouldBubbleSort() {
        int[] array = new int[]{10, 4, 9};
        Pendulum pendulum = new Pendulum();
        pendulum.bubbleSort(array);
